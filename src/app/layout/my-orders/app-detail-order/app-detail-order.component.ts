...
export class AppDetailOrderComponent implements OnInit {
    ...
    swal
      ...
      .then((result) => {
        if (result.value) {
          ...
          swal.fire(
            "Zrealizowanie Zamówienia",
            "Zamówienie nadal czeka na realizację.",
            "info"
          );
        }
      });
  ...
  public addHistoryFromUser(): void {
    ...
    const admin = this.layoutManageService.adminsData
      .getValue()
