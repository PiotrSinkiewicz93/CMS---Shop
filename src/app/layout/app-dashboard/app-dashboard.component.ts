...
export class AppDashboardComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.productManageService.productsData.subscribe(
      (pr) => (this.products = pr)
    );
    this.messagesManageService.messageData.subscribe(
      (m) => (this.messages = m)
    );
    ...
    this.chartSecond = new Chart(this.chartSecondRef.nativeElement, {
      ...
      data: {
        ...
        datasets: [
          {
            data: [
              2150, 1700, 4500, 1200, 1810, 1400, 4500, 11150, 650, 850, 2110,
              4500,
            ],
            borderColor: "#886ce6",
            fill: true,
    ...
    this.firebaseService
      ...
      .then(() =>
        Swal.fire(
          ...
          "Wiadomość została oznaczona jako przeczytana.",
          "success"
        )
      );
  }
  ...
  public markLastFiveMessage(): void {
      ...
      if (messages.length > 0) {
        ...
        this.firebaseService
          ...
          .then(() =>
            Swal.fire(
              "Oznaczenie wiadomości",
              "Wiadomości zostały oznaczone jako przeczytana.",
              "success"
            )
          );
        return;
    ...
    Swal.fire(
      "Oznaczenie wszystkich wiadomości",
      "Brak wiadomości do oznaczenia",
      "error"
    );
  }
}
