...
export class AppSignInComponent implements OnInit {
  ...
  public submitLogin(): void {
    ...
    if (this.loginAccountForm.valid) {
      ...
      swal.fire(
        "Logowanie",
        "Wypełnij prawidłowo formularz logowania!",
        "warning"
      );
    }
  }
  ...
  public getRefAuth(): any {
    return this.firebaseService.firebase
      .auth()
  ...
  public generateErrorSwal(error): void {
    if (
      ...
      swal.fire(
        "Logowanie",
        "Użytkownik z takim emailem nie istnieje!",
        "error"
      );
    } else if (error.code === "auth/operation-not-allowed") {
      swal.fire(
        "Logowanie",
        "Logowanie i rejestracja zostały zablokowane!",
        "error"
      );
    } else {
